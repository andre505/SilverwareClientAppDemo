        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientType = table.Column<int>(type: "int", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ClientPOSService",
                columns: table => new
                {
                    ClientsId = table.Column<int>(type: "int", nullable: false),
                    POSServicesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientPOSService", x => new { x.ClientsId, x.POSServicesId });
                    table.ForeignKey(
                        name: "FK_ClientPOSService_Clients_ClientsId",
                        column: x => x.ClientsId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientPOSService_POSServices_POSServicesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientPOSService_POSServicesId",
                table: "ClientPOSService",
